...
CREATE TABLE `cervezas` (
  ...
  CONSTRAINT `cervezas_ibfk_1` FOREIGN KEY (`id_categoria`) REFERENCES `categoria` (`id_categoria`)
...
INSERT INTO `cervezas` VALUES (300,'poker','dtl_poker',1),(301,'aguila','dlt_aga',2),(302,'ligth','dlt_lgh',1),(303,'andina','dlt_ada',2),(304,'redds','dlt_rds',2),(305,'club colombia','dlt_cuc',1);
